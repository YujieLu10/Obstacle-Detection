...
class pvalite_b5(Symbol):
    ...
    def inc3_unit_left(self, data, name, workspace=512):
        conv5_1 = mx.sym.Convolution(data=data,bias=0.1,num_filter=16,kernel=(1,1),stride=(1,1),pad=0,no_bias=False,workspace=workspace,name=name+'/conv5_1')
        relu5_1 = mx.sym.Activation(data=conv5_1, act_type='relu', name=name+'/relu5_1')
        if 'inc4' in name or 'inc5' in name:
            conv5_2 = mx.sym.Convolution(data=relu5_1,bias=0.1, num_filter=32,kernel=(3,3),stride=(1,1),dilate=(2,2),pad=(1,1),no_bias=False,workspace=workspace,name=name+'/conv5_2')
            relu5_2 = mx.sym.Activation(data=conv5_2, act_type='relu', name=name+'/relu5_2')
            conv5_3 = mx.sym.Convolution(data=relu5_2,bias=0.1, num_filter=32,kernel=(3,3),stride=(1,1),dilate=(2,2),pad=(1,1),no_bias=False,workspace=workspace,name=name+'/conv5_3')
            relu5_3 = mx.sym.Activation(data=conv5_3, act_type='relu', name=name+'/relu5_3')
        else:
            conv5_2 = mx.sym.Convolution(data=relu5_1,bias=0.1, num_filter=32,kernel=(3,3),stride=(1,1),pad=(1,1),no_bias=False,workspace=workspace,name=name+'/conv5_2')
            relu5_2 = mx.sym.Activation(data=conv5_2, act_type='relu', name=name+'/relu5_2')
            conv5_3 = mx.sym.Convolution(data=relu5_2,bias=0.1, num_filter=32,kernel=(3,3),stride=(1,1),pad=(1,1),no_bias=False,workspace=workspace,name=name+'/conv5_3')
            relu5_3 = mx.sym.Activation(data=conv5_3, act_type='relu', name=name+'/relu5_3')
        return relu5_3

    def inc3_unit_middle(self, data, name, workspace=512):
        conv3_1 = mx.sym.Convolution(data=data, bias=, num_filter=16,kernel=(1,1),stride=(1,1),pad=0,no_bias=False,workspace=workspace,name=name+'/conv3_1')
    ...
    def inc3_unit_right(self, data, num_output, name, workspace=512):
        conv1 = mx.sym.Convolution(data=data, num_filter=num_output,kernel=,stride=,pad=,no_bias=False,workspace=workspace,name=name+'/conv1')
