...
class MNIteratorE2E(MNIteratorBase):
    ...
    def _get_batch(self):
        ...
        for i in range(n_batch):
            #print 'roidb'
            #print [roidb[i]['image'], roidb[i]['image'], roidb[i]['crops'][cropids[i]], roidb[i]['flipped']]
            ims.append([roidb[i]['image'], roidb[i]['crops'][cropids[i]], roidb[i]['flipped']])
        print '>>>>>'
        #ims =[[['/private/luyujie/obstacle_detector/obstacle_detector/data/obstacle2d/ImageSets/val0629.txt', [array([626.27474505, 208.75824835, 932.81343731, 515.29694061]), 1.667, 512, 512], False], ['/private/luyujie/obstacle_detector/obstacle_detector/data/obstacle2d/ImageSets/val0629.txt', [array([1461.30773845,  243.55128974, 1767.84643071,  550.089982  ]), 1.667, 512, 512], True], ['/private/luyujie/obstacle_detector/obstacle_detector/data/obstacle2d/ImageSets/val0629.txt', [array([1102.        ,  154.66666667, 1272.33333333,  325.        ]), 3.0, 512, 512], False]]]
       # print ims
