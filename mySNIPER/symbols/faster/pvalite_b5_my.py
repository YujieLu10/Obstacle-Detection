...
class pvalite_b5(Symbol):
    ...
    def get_symbol_rcnn(self, cfg, is_train=True):
        ...
        offset_t = mx.contrib.sym.DeformablePSROIPooling(name='offset_t', data=rpn_relu1, rois=proposal, group_size=1, pooled_size=7, sample_per_part=4, no_trans=True, part_size=7, output_dim=256, spatial_scale=0.0625)
        ...
        deformable_roi_pool = mx.contrib.sym.DeformablePSROIPooling(name='deformable_roi_pool', data=rpn_relu1, rois=proposal,trans=offset_reshape, group_size=1, pooled_size=7, sample_per_part=4, no_trans=False, part_size=7, output_dim=256, spatial_scale=0.0625, trans_std=0.1)
