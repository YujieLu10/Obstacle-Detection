...
printf "\n$help_str\n"
exit; fi
if [ -z ${prop_save_path} ]; then prop_save_path="/home/luyujie/SNIPER/data/computed_proposals"; fi
if [ -z ${prop_train_path} ]; then prop_train_path="/home/luyujie/SNIPER/output/sniper_neg_proposals"; fi
