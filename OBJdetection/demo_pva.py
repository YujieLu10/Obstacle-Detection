...
from inference_my import Tester
...
def main():
    ...
    for filename in os.listdir(r"/home/luyujie/val1010"):
        # Get image dimensions
        filepath = os.path.join('/home/luyujie/val1010', filename)
        ...
        all_detections = tester.aggregate(all_detections, vis=True, cache_name=None, vis_path='/home/luyujie/val1010_pva_COCO_demo',
