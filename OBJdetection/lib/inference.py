...
class Tester(object):
    ...
    def get_detections(self, cls_thresh=1e-3, cache_name= 'cache', evaluate= False, vis=True, vis_path=None,
                       vis_ext='.png'):
        #print('>>>>> num classes {} class name{}'.format(self.num_classes, self.class_names))
        all_boxes = [[[] for _ in range(self.num_images)] for _ in range(self.num_classes)]
        data_counter = 0
