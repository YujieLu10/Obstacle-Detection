...
from dataset.coco import COCO as COCODT
...
class COCOeval:
    ...
    def __init__(self, cocoGt=None, cocoDt=None):
        ...
        :return: None
        '''
        #cocoGt = COCO('/home/luyujie/SNIPER/data/coco/annotations/image_info_test-dev2015.json')
        #cocoDt = COCO('/home/luyujie/SNIPER/output/sniper_res101_bn/results/detections_test-dev2015_results.json')
        #cocoGt = COCO('/home/luyujie/SNIPER/data/coco/annotations/image_info_test2015.json')
        #cocoDt = COCO('/home/luyujie/SNIPER/output/pvalite_b5_bn/results/detections_test2015_results.json')
        #cocoDt = COCO('/home/luyujie/SNIPER/output/pvalite_b5_bn/results/detections_test-dev2015_results.json')
        #print('>>>>>>> init cocoeval')
        ...
        #self._paramsEval = Params()
        if not cocoGt is None:
            self.params.imgIds = sorted(cocoGt.getImgIds())
            self.params.catIds = sorted(cocoGt.getCatIds())
        '''
        if not cocoDt is None:
            self._paramsEval.imgIds = sorted(cocoDt.getImgIds())
            self._paramsEval.catIds = sorted(cocoGt.getCatIds())
        '''
    ...
    def _prepare(self):
        ...
        p = self.params
        #print('>>>> self._paramsEval.imgIds {}  self._paramsEval.catIds {}'.format(self._paramsEval.imgIds, self._paramsEval.catIds))
        #print('>>>>> self.cocoDt.getAnnIds(imgIds=p.imgIds, catIds=p.catIds) {} '.format(self.cocoDt.getAnnIds(imgIds=self._paramsEval.imgIds, catIds=self._paramsEval.catIds)))
        #print('>>>>> self.cocoGt.getAnnIds(imgIds=p.imgIds, catIds=p.catIds) {}'.format(self.cocoGt.getAnnIds(imgIds=p.imgIds, catIds=p.catIds)))
    ...
    def computeIoU(self, imgId, catId):
        ...
        #print('>>>>>> d {} g {} iscrowd {}'.format(d, g, iscrowd))
        return ious
...
class Params:
    ...
    def __init__(self):
        ...
        #print('>>>>> self.iouThrs {}  self.recThrs {}'.format(self.iouThrs, self.recThrs))
