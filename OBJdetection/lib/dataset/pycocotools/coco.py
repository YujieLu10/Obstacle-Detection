...
class COCO:
    def __init__(self, annotation_file=None):
        ...
        #    annotation_file = '/home/luyujie/SNIPER/data/coco/annotations/image_info_test2015.json'
        # load dataset
        self.dataset = {}
        self.anns = []
        self.imgToAnns = {}
        ...
        if not annotation_file == None:
            #print('>>>>> annotationfile {}'.format(annotation_file))
    ...
    def createIndex(self):
        ...
        if 'annotations' in self.dataset:
            #print('>>>>> annotations in self.dataset')
    ...
    def loadRes(self, resFile):
        ...
        """
        res = COCO()
        #print('>>>>> res.dataset {}'.format(res.dataset))
