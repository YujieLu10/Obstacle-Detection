...
if __name__ == '__main__':
   ...
   # print roidb
    ...
    print('>>>> config.network.pretrained {}'.format(config.network.pretrained))
    arg_params, aux_params = load_param(config.network.pretrained, config.network.pretrained_epoch, convert=True)
    #arg_params = {}
    #aux_params = {}
    #print('>>>>>> main train.py  arg_params{}'.format(arg_params))
    #print('>>>>>> main train.py  aux_params{}'.format(aux_params))
