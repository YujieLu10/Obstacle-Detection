...
with open(trainpath + trainsetfile) as f:
    ...
    for filename in os.listdir(r"/home/luyujie/SNIPER/data/coco/images/train2014"):
        cnt += 1
        # after resize image read image information
        imagepath = os.path.join('/home/luyujie/SNIPER/data/coco/images/train2014', filename)
        ...
        dataset['images'].append({'license': 5, 'file_name': imagepath, 'coco_url': "local", 'height': height, 'width': width, 'date_captured': "2018_08_29 10:10:10", 'flickr_url': "local", 'id': cnt})
