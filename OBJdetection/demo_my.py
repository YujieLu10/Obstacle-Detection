...
def parser():
    ...
    arg_parser.add_argument('--cfg', dest='cfg', help='Path to the config file',
    							default='configs/faster/sniper_mobilenetv2_e2e.yml',type=str)
...
def main():
    ...
    context = [mx.gpu(int(7))]
    #context = [mx.gpu(int(gpu)) for gpu in config.gpus.split(',')]
    if not os.path.isdir(config.output_path):
        os.mkdir(config.output_path)
    for filename in os.listdir(r"/home/luyujie/demo"):
        # Get image dimensions
        filepath = os.path.join('/home/luyujie/demo', filename)
        ...
        all_detections = tester.aggregate(all_detections, vis=True, cache_name=None, vis_path='/home/luyujie/demo_res',
